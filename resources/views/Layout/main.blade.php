    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/admin')}}">
                ...
                <div class="sidebar-brand-text mx-3"><img src="{{url('/cj.png')}}" width='50' height='50' />Admin </div>
            </a>
            ...
            <!-- Nav Item - User -->
            <li class="nav-item">
                <a class="nav-link" href="{{url('/admin/duser')}}">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="{{url('/admin/dadmin')}}">
